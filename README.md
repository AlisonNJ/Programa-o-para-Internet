...
index.php:
Esse é o menu de login, é nele que você coloca os dados cadastrados no banco de dados, no arquivo ele inclui os dados da 'conexao.php' para saber e identificar se os dados colocados no 'index.php' estão no banco de dados, se tiverem, ele vai ser levado pro 'painel.php', caso não tiver, ele manda uma mensagem dizendo "Falha ao Login";
...
logout.php:
É com ele que faz a transição de sair da conta e ir para a tela do index, incerrando a sessão com o 'section_destroy()';
